...
downloads_folder = myPreferences.screenCapture_Path()
files = [
...
fileIndex = 0
print(f"{myTerminal.INPUTPROMPT}Recent files in screen capture pick up folder:{myTerminal.RESET}")
...
if fileIndex == 0:
    print(f"{myTerminal.ERROR}No files found in the screen capture pick up folder.{myTerminal.RESET}")
    exit(1)    
