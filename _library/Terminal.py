...
consoleColours = [RED, GREEN, YELLOW, BLUE, MAGENTA, CYAN, WHITE, GREY, RESET, CLEAR]
...
def addColourToLine(textToPrint: str, colour: str = "Red") -> str:
    ...
    if colour.lower() == "blue":
        ...
        textColour = WHITE
    elif colour.lower() in ("grey", "gray"):
        textColour = GREY
