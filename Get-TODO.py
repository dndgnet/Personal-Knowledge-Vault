...
todoNotes = myTools.get_Note_with_TODO(myPreferences.root_pkv())

if not todoNotes:
    print(f"{myTerminal.GREEN}No TODO items found.{myTerminal.RESET}")
    exit(0)

index = 0    
print(f"{myTerminal.SUCCESS} {len(todoNotes)} TODO items found:{myTerminal.RESET}")
