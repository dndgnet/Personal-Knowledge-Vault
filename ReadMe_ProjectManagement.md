...
```json
{
    ...
    "PrivateShareFolder": "Path to the folder where raw markdown files will be shared.  Typically this is a shared network drive, OneDrive, SharePoint, iCloud, etc. location that is accessible to the team.  If this value is not set, then notes will not be shared.",
    "PublicShareFolder": "Path to the folder where published PDF files will be shared.  Typically this is a shared network drive, OneDrive, SharePoint, iCloud, etc. location that is accessible to the team.  If this value is not set, then notes will not be published.
